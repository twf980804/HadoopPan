...
<body style="text-align:center;margin-bottom:100px;">
	     ...
	     <div class="navbar-inner">
	       <a class="brand" href="#" style="margin-left:200px;" font="50px">网盘</a>
	       <ul class="nav">
			...
			for (int i=0; i<list.length; i++) {
				%>
					...
					%>
						...
						<td><a href="DeleteFileServlet?filePath=<%=java.net.URLEncoder.encode(list[i].getPath().toString(),"GB2312") %>" class = "delete">删除</a></td>
